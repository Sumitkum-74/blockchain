  ...
  const startChatAgain = () => {
    ...
    return (
        <div className='fixed bottom-4 right-4 w-80 h-96 bg-white border border-gray-300 rounded-md shadow-md overflow-hidden chatbot'>
            ...
            <div className='flex justify-between items-center p-4 border-b border-gray-300 bg-black'>
            ...
            <div className='overflow-y-auto p-4 h-64 chatbot-messages'>
                    ...
                    <div className='message bg-black  p-2 rounded-md mb-2'>
                        Hello user, how can I help you today?
                    </div>
                {botMessages.map((message, index) => (
                    <div key={index} className='message bg-black p-2 rounded-md mb-2'>
                        {message.text}
                    </div>
                ))}
            </div>

            <div className='p-4 border-t border-gray-300 bg-black'>
